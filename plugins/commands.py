...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton(' Updates ', url='https://t.me/BAGURUJOINAGUUKANNADAMOVIES_17')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton(' Updates', url='https://t.me/BAGURUJOINAGUUKANNADAMOVIES_17'),
            InlineKeyboardButton('Group ', url='https://t.me/Baagurujoinaguu')
            ],[
    ...
    buttons = [
        [
            InlineKeyboardButton(' Support Group', url='https://t.me/Baagurujoinaguu'),
            InlineKeyboardButton('Channel ', url='https://t.me/BAGURUJOINAGUUKANNADAMOVIES_17')
        ],
        [
            InlineKeyboardButton('🎬 🍿Movies 🎬', url=f'https://t.me/BAGURUJOINAGUUKANNADAMOVIES_17')
        ]
        ]
    await client.send_cached_media(
        chat_id=message.from_user.id,
